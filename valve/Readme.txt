...
Date: 30/03/2020
- Added mp_respawn_fix cvar.
- Added mp_wallgauss cvar.
- Added mp_rpg_fix cvar.
- Added mp_blastradius cvar.
- Added mp_dmg_xxx cvars. Example: "mp_dmg_glock".
- Fix for bots not being send to welcomecam when they join (Useful for send players to spec when they join).
- Not allow to leave welcome cam too soon (Useful for send players to spec when they join).
